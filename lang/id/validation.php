...
return [
    ...
    */
    ...
    'in' => 'Pilih :attribute tidak valid.',
    ...
    'not_in' => 'Pilih :attribute tidak valid.',
    ...
    'required_if_accepted' => 'Kolom :attribute harus diisi ketika :other telah diterima.',
    'required_unless' => 'Kolom :attribute harus diisi kecuali :other adalah salah satu dari :values.',
    ...
    'required_without_all' => 'Kolom :attribute harus diisi ketika tidak ada salah satu dari :values yang ada.',
    ...
    |--------------------------------------------------------------------------
    |
    | Di sini Anda dapat menambahkan baris bahasa validasi kustom untuk atribut
    | tertentu menggunakan format "atribut.aturan" untuk penamaan. Ini memudahkan
    | penyesuaian pesan kesalahan untuk berbagai atribut.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Baris Bahasa Validasi Atribut Kustom
    |--------------------------------------------------------------------------
    |
    | Di sini Anda dapat mengganti nama atribut yang ditampilkan dengan nama yang lebih
    | mudah dibaca seperti "Alamat Email" daripada "email". Ini akan memudahkan
