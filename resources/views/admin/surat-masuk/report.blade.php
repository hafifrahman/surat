...
@section('content')
    ...
    <div
      ...
      <div class="mb-1 w-full">
        <div class="mb-4">
          ...
          <h1 class="text-xl font-semibold text-slate-900 dark:text-white sm:text-2xl">Laporan Surat Masuk</h1>
        </div>
        <div class="sm:flex">
                ...
                @foreach (range(1, 12) as $bulan)
                  <tr>
                    ...
                    <td class="space-x-2 whitespace-nowrap px-4 py-2 text-center">
                      <a href="{{ route(currentRole() . '.laporan-sm.report', ['bulan' => $bulan, 'tahun' => $tahun]) }}">
                        <x-danger-button>
                          Cetak
                        </x-danger-button>
                      </a>
  ...
  <script>
    function handleYearChange() {
      ...
      window.location.href = `{{ url('admin/laporan-sm') }}?tahun=${selectedYear}`;
    }
  </script>
@endsection
