...
@section('content')
  <div class="mx-auto flex h-screen flex-col items-center justify-center px-6 dark:bg-gray-900 xl:px-0">
    <div class="mb-5 block md:max-w-md">
      <img src="{{ asset('/img/errors/maintenance.svg') }}" alt="maintenance image">
    </div>
    <div class="text-center xl:max-w-4xl">
      <h1 class="mb-5 text-2xl font-bold leading-tight text-gray-900 dark:text-white sm:text-4xl lg:text-5xl">Under
        maintenance</h1>
      <a href="/"
